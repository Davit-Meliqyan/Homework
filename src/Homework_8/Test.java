...
public class Test {
    ...
    public static void printAbs() {
        ...
        if (Math.abs(n) > 1000000) abs = "large";
        else if (Math.abs(n) < 1 && Math.abs(n) != 0) abs = "small";
    ...
    public static void iceCream() {
        ...
        int n = scanner.nextInt();
        if (n == 0 || n == 1 || n == 2 || n == 4 || n == 7) System.out.print("No");
        else {
    ...
    public static void greatestNumber() {
        ...
        if (c >= a && c >= b) System.out.println("greatest number " + c);
        else if (b >= a && b >= c) System.out.println("greatest number " + b);
        else System.out.println("greatest number " + a);
    }
    ...
    public static void weekday() {
        ...
        if (n > 0 && n < 8) {
            ...
            if (n == 2) System.out.println("Monday");
            if (n == 3) System.out.println("Tuesday");
            if (n == 4) System.out.println("Wednesday");
            if (n == 5) System.out.println("Thursday");
            if (n == 6) System.out.println("Friday");
            if (n == 7) System.out.println("Saturday");
        } else System.err.println("ERROR");
    ...
    public static void randomFilter() {
        ...
        if ((result > -10000 && result < 10000) && (result % 3 == 0 || result % 5 == 0)) System.out.println(true);
    ...
    public static void multipleOf7() {
        ...
        if ((a > 0 && b > 0) && (a % 7 == 0 || b % 7 == 0)) {
            if (a > b) {
                if (b % 2 == 0) {
                    for (int i = b + 1; i <= a; i += 2) System.out.print(i + " ");
                } else for (int i = b; i <= a; i += 2) System.out.print(i + " ");
            } else {
                if (a % 2 == 0) {
                    for (int i = a; i <= b; i += 2) System.out.print(i + " ");
                } else for (int i = a + 1; i <= b; i += 2) System.out.print(i + " ");
            }
        }
    }

    public static void quarterOfPoint() {
        System.out.println("Input x coordinates");
        int x = scanner.nextInt();
        System.out.println("Input y coordinates");
        int y = scanner.nextInt();
        if (x == 0 || y == 0) System.out.println("Not in the same quarter");
        if (x > 0 && y > 0) System.out.println("1 quarter");
        if (x < 0 && y > 0) System.out.println("2 quarter");
        if (x < 0 && y < 0) System.out.println("3 quarter");
        if (x > 0 && y < 0) System.out.println("4 quarter");
    ...
    public static void degenerateTriangle() {
        ...
        if (a == 0 || b == 0 || c == 0) {
            ...
            if (a + b > c && a + c > b && b + c > a) System.out.println("triangle is not degenerate");
            else System.out.println("triangle is degenerate");
        }
    ...
    public static void equalsNumbers() {
        ...
        else if (num1 == num2 && num2 == num3) System.out.println(3);
        else System.out.println("Numbers is not equals ");
    }
    ...
    public static void quadraticEquation() {
        ...
        if (a == 0) System.out.println("Not quadratic equation");
        else {
            double D = b * b - 4 * a * c;
            if (D < 0) System.out.println("quadratic equation has no real solution");
            else if (D == 0) {
                double x = -b / 2 * a;
